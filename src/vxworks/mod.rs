...
s! {
    ...
    pub struct stat {
        ...
        pub st_size: off_t,
        #[cfg(not(vxworks_version_old))]
        pub st_atim: timespec,
        #[cfg(vxworks_version_old)]
        pub st_atim: crate::time_t,
        #[cfg(not(vxworks_version_old))]
        pub st_mtim: timespec,
        #[cfg(vxworks_version_old)]
        pub st_mtim: crate::time_t,
        #[cfg(not(vxworks_version_old))]
        pub st_ctim: timespec,
        #[cfg(vxworks_version_old)]
        pub st_ctim: crate::time_t,
...
cfg_if! {
    if #[cfg(feature = "extra_traits", vxworks_version_old)] {
        impl PartialEq for sa_u_t {
            ...
            impl hash::Hash for sa_u_t {
                fn hash<H: hash::Hasher>(&self, state: &mut H) {
                    unsafe {
                        (self.sa_handler as usize).hash(state)
                    };
                }
            }
        }
